...
figure; plot(grains, grains.meanOrientation); title('Full clean')
exportScaledFigure(gcf, 'CleanedPseudoSym_Grains.png')
...
hold off
exportScaledFigure(gcf, 'Identified_Sigma_Boundaries.png')
...
exportScaledFigure(gcf, 'GBND_CrystalFrame.png')
...
h = Miller(0,0,0,1, CS);
annotate(h, 'labeled', 'backgroundColor', 'w', 'fontWeight', 'bold');
exportScaledFigure(gcf, 'GBCD_Sigma_CrystalFrame.png')
...
h = Miller(0,0,0,1, CS);
annotate(h, 'labeled', 'backgroundColor', 'w', 'fontWeight', 'bold');
exportScaledFigure(gcf, 'GBCD_Recommended_Sigma_CrystalFrame.png')
...
figure;
plot(grains, grainColors, 'faceAlpha', 0.15)
hold on
...
exportScaledFigure(gcf, 'Trace_Consistency_Analysis.png')
